...
def getPersonLabel(number):
    ...
    MODEL_NAME = '1025_person_frcnn_bs1_4000_graph'
    ...
    PATH_TO_LABELS = os.path.join('1025_person_frcnn_bs1_4000_graph', 'object-detection.pbtxt')
    NUM_CLASSES = 14

    TEST_IMAGE_PATHS = [ os.path.join('./media/photos/person/', 'person' + number + '.jpg')]
    ...
    for image_path in TEST_IMAGE_PATHS:
      ...
      now = datetime.now()
      cv2.imwrite('./analysis/static/labelImage/' + 'personLabel' + number + '.jpg', image_np)
      if os.path.exists('./analysis/static/labelImage/' + 'personLabel' + number + '.jpg'):
          print('finish')
          print(now)
