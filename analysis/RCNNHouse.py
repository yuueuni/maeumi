...
def getHouseLabel(number):
    ...
    MODEL_NAME = '1025_rcnn_house_4000_bs1_plus'
    ...
    TEST_IMAGE_PATHS = [os.path.join('./media/photos/house/', 'house' + number + '.jpg')]
    ...
    for image_path in TEST_IMAGE_PATHS:
        ...
        now = datetime.now()
        cv2.imwrite('./analysis/static/labelImage/' + 'houseLabel' + number + '.jpg', image_np)
        if os.path.exists('./analysis/static/labelImage/' + 'houseLabel' + number + '.jpg'):
            print('finish')
            print(now)
